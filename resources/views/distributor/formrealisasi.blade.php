            ...
            <div class="card shadow p-3 mb-5 bg-body rounded">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">Rekap Realisasi Pupuk</h3>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <div class="pl-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="harga" id="input-harga" class="form-control"
                                    placeholder="Tahun" value="" required="">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="form-control-label" for="input-harga">Alokasi Pupuk Pertahun</label>
                                <input type="number" name="harga" id="input-harga" class="form-control"
                                    placeholder="Jumlah" value="" required="">
                            </div>
                            <div class="form-group">
                                <label class="form-control-label" for="input-harga">Realisasi Pupuk Pertahun</label>
                                <input type="number" name="harga" id="input-harga" class="form-control"
                                    placeholder="Jumlah" value="" required="">
                            </div>
